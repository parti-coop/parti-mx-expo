...
export const Grey15: React.FunctionComponent<TextProps> = (props) => (
  <T
    {...props}
    style={[
      {
...
export const Body14: React.FunctionComponent<TextProps> = (props) => (
  <T
    {...props}
    style={[
      {
...
export const White11: React.FunctionComponent<TextProps> = (props) => (
  <T
    {...props}
    style={[
      {
...
export const White13: React.FunctionComponent<TextProps> = (props) => (
  <T
    {...props}
    style={[
      {
...
export const White18: React.FunctionComponent<TextProps> = (props) => (
  <T
    {...props}
    style={[
      {
